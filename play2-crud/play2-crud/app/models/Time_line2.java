 ...
 */
@Entity
@Table(name="time_line2")
public class Time_line2 extends Model {
    ...
    public static Finder<Long, Time_line2> find = new Model.Finder<Long, Time_line2>("default",Long.class, Time_line2.class);
